...
// picsum.photos seeds — deterministic per seed, CORS-enabled, always loads
// Seeds chosen to evoke relevant moods: dark tech for cyber, bright tech for data
const img = (seed) => `https://picsum.photos/seed/${seed}/1200/628`;
    ...
    short: [
      {
        ...
        headline: 'AI Doesn\'t Just Detect Threats.\nIt Ends Alert Fatigue.',
        images: [img('cyber10'), img('network22'), img('monitor15')]
      },
      {
        ...
        headline: '200+ Days of Dwell Time.\nEvery Day Costs You.',
        images: [img('darktech5'), img('threat9'), img('binary7')]
      },
      {
        ...
        headline: 'Most Targeted.\nLeast Protected.',
        images: [img('shield3'), img('enterprise8'), img('protect11')]
      },
      {
        ...
        headline: 'Attackers Are Already\nUsing AI. Are You?',
        images: [img('aitech4'), img('neural6'), img('machine2')]
      },
      {
        ...
        images: [img('lock14'), img('access18'), img('identity21')]
      },
      {
        ...
        headline: 'The Best Insurance Is\na Tested IR Plan.',
        images: [img('risk31'), img('business33'), img('plan29')]
      },
      {
        ...
        headline: '3.5M Unfilled Cyber Roles.\nClose the Gap Now.',
        images: [img('team40'), img('workforce42'), img('analyst38')]
      },
      {
        ...
        headline: 'Compliance Gets You a Certificate.\nSecurity Keeps You in Business.',
        images: [img('audit50'), img('policy52'), img('governance55')]
      }
    ],
    medium: [
      {
        ...
        headline: 'Most Breaches Start\nWith the Basics You Skipped.',
        images: [img('email60'), img('breach62'), img('patch64')]
      },
      {
        ...
        headline: 'Tools Aren\'t a Program.\nPrograms Stop Breaches.',
        images: [img('ciso70'), img('strategy72'), img('program74')]
      },
      {
        ...
        headline: 'AI Gives Analysts\nTheir Focus Back.',
        images: [img('aiops80'), img('analyst82'), img('detect84')]
      },
      {
        ...
        headline: 'Threat Actors Are Patient.\nYour Defense Should Be Faster.',
        images: [img('hunt90'), img('killchain92'), img('proactive94')]
      }
    ]
  },
    ...
    short: [
      {
        ...
        headline: 'You Can\'t Build AI\non Broken Data.',
        images: [img('data100'), img('pipeline102'), img('foundation104')]
      },
      {
        ...
        images: [img('apps110'), img('software112'), img('stack114')]
      },
      {
        ...
        headline: 'AI Agents Are Only as Good\nas Their Data Access.',
        images: [img('robot120'), img('automate122'), img('workflow124')]
      },
      {
        ...
        headline: 'Batch Processing Is\nYesterday\'s Answer.',
        images: [img('stream130'), img('realtime132'), img('speed134')]
      },
      {
        ...
        headline: '$3 Trillion Lost\nto Bad Data. Every Year.',
        images: [img('quality140'), img('records142'), img('database144')]
      },
      {
        ...
        headline: 'Legacy Systems Don\'t\nJust Slow You Down. They Block You.',
        images: [img('legacy150'), img('modern152'), img('migrate154')]
      },
      {
        ...
        headline: 'Every Well-Designed API Is\na Door You Can Open.',
        images: [img('api160'), img('code162'), img('developer164')]
      },
      {
        ...
        headline: 'The AI Leaders\nAll Fixed Their Data First.',
        images: [img('winner170'), img('dataai172'), img('connected174')]
      }
    ],
    medium: [
      {
        ...
        headline: 'Fix the Data\nBefore You Buy the AI.',
        images: [img('aiready180'), img('infra182'), img('mlops184')]
      },
      {
        ...
        headline: 'Every Initiative Pays\nthe Integration Tax.',
        images: [img('cto190'), img('platform192'), img('efficiency194')]
      },
      {
        ...
        headline: 'Without the Right APIs,\nAgents Are Just Chatbots.',
        images: [img('agentai200'), img('orchestrate202'), img('backbone204')]
      },
      {
        ...
        headline: 'Transformation Stalls\non Integration Architecture.',
        images: [img('transform210'), img('platform212'), img('enterprise214')]
      }
    ]
  }
};
...
async function generatePost() {
  ...
  await renderCanvas(currentPost, COMPANIES[currentCompany], 0);
...
// ─── Canvas renderer ──────────────────────────────────────────────────────────
async function renderCanvas(post, company, imgIdx) {
  const W = 1200, H = 628;
  canvas.width = W;
  canvas.height = H;
  ...
  try {
    const photo = await loadImage(post.images[imgIdx]);
  ...
  // 2. Dark overlay — heavier if photo loaded so text is readable
  ctx.fillStyle = photoLoaded ? 'rgba(6,16,28,0.62)' : 'rgba(6,16,28,0.9)';
  ctx.fillRect(0, 0, W, H);

  // 3. Centered headline text
  const lines = post.headline.split('\n');
  const fontSize = lines.some(l => l.length > 30) ? 52 : 60;
  ...
  let y = H / 2 - totalH / 2 + fontSize * 0.65;
  ...
  grad.addColorStop(1, 'rgba(6,16,28,0.95)');
  ctx.fillStyle = grad;
  ctx.fillRect(0, H - 110, W, 110);

  ctx.fillStyle = '#ffffff';
  ctx.font = 'bold 24px Arial, sans-serif';
  ctx.fillText(company.name.toUpperCase(), 52, H - 44);

  ctx.fillStyle = '#b0bec8';
  ctx.font = '16px Arial, sans-serif';
  ctx.fillText(company.tagline, 52, H - 18);

  // 6. Orange bottom accent bar
  ctx.fillStyle = company.accentColor;
