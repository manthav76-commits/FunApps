    ...
    short: [
      {
        ...
        image: 'https://images.unsplash.com/photo-1614064641938-3bbee52942c7?w=1200&h=628&fit=crop&auto=format'
      },
      {
        ...
        image: 'https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=1200&h=628&fit=crop&auto=format'
      },
      {
        ...
        image: 'https://images.unsplash.com/photo-1563206767-5b18f218e8de?w=1200&h=628&fit=crop&auto=format'
      },
      {
        ...
        image: 'https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=1200&h=628&fit=crop&auto=format'
      },
      {
        ...
        image: 'https://images.unsplash.com/photo-1510511459019-5dda7724fd87?w=1200&h=628&fit=crop&auto=format'
      },
      {
        ...
        image: 'https://images.unsplash.com/photo-1504384308090-c894fdcc538d?w=1200&h=628&fit=crop&auto=format'
      },
      {
        ...
        image: 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=1200&h=628&fit=crop&auto=format'
      },
      {
        ...
        image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=1200&h=628&fit=crop&auto=format'
      }
    ],
    medium: [
      {
    ...
    short: [
      {
        ...
        image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1200&h=628&fit=crop&auto=format'
      },
      {
        ...
        image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1200&h=628&fit=crop&auto=format'
      },
      {
        ...
        image: 'https://images.unsplash.com/photo-1573164713988-8665fc963095?w=1200&h=628&fit=crop&auto=format'
      },
      {
        ...
        image: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=1200&h=628&fit=crop&auto=format'
      },
      {
        ...
        image: 'https://images.unsplash.com/photo-1504868584819-f8e8b4b6d7e3?w=1200&h=628&fit=crop&auto=format'
      },
      {
        ...
        image: 'https://images.unsplash.com/photo-1607799279861-4dd421887fb3?w=1200&h=628&fit=crop&auto=format'
      },
      {
...
async function generatePost() {
  ...
  await renderCanvas(currentPost, COMPANIES[currentCompany]);
...
async function renderCanvas(post, company) {
  const W = 1200, H = 628;
  canvas.width = W;
  canvas.height = H;
